...
export const metadata = {
  title: "iWallet — Your agent's wallet, governed",
};

/**
 * Revolut-style landing redesign, built page by page. Lives at /landing for
 * review; promote to / once the team signs off.
 */
export default function LandingPage() {
  return (
    <main className="bg-canvas text-ink">
      ...
      {/* The page continues on the white the rectangle expanded into. */}
